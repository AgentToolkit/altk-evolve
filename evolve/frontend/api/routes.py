...
def get_dashboard() -> dict[str, Any]:
    from evolve.frontend.mcp.mcp_server import get_client
...
def create_namespace_entity(namespace_id: str, req: EntityCreateRequest) -> dict[str, Any]:
    from evolve.frontend.mcp.mcp_server import get_client
    from evolve.schema.core import Entity
    from fastapi import HTTPException
    ...
    if entity_type == "guideline":
        from evolve.schema.tips import Tip
        ...
        from evolve.schema.policy import Policy, PolicyType
