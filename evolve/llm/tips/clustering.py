...
from evolve.schema.tips import Tip, TipGenerationResponse
from evolve.utils.utils import clean_llm_response
...
def cluster_entities(
    ...
    if embedding_model is None:
        from evolve.config.milvus import milvus_other_settings
