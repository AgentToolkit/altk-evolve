---
description: Generate pseudo-conversation test fixtures for newly saved atomic skills. Run this immediately after evolve-lite-learn has finished saving entities.
---
