---
name: evolve-lite-create-tests
description: >-
  Create pseudo-conversation test fixtures for all atomic skills, or for
  specific new skill files. Run this after evolve-lite-learn to generate tests
  for newly saved skills.
metadata:
  user-invocable: true
