#!/usr/bin/env python3
"""
Evolve Skill: Learn (Stage 2 Filesystem Backend)
Reads extracted entities from stdin and saves them to .evolve/entities.json.
...
def main():
    print("[Evolve Learn] Processing extracted entities...")
    ...
    entities_file = evolve_dir / "entities.json"

    if not evolve_dir.exists():
        print(f"Creating storage directory: {evolve_dir}")
