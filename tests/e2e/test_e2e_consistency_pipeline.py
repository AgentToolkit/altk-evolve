...
"""
    ...
    print("\n--- Step 3: Running evolve sync phoenix --guidelines-mode consistency ---")
    sync_command = [
        "uv", "run", "evolve", "sync", "phoenix",
        "--project", project_name,
        "--guidelines-mode", "consistency",
        "--include-errors",
        "--limit", "500",
    ]
    debug_dir = pytestconfig.getoption("--consistency-debug-dir")
    if debug_dir:
        sync_command += ["--debug-output-dir", debug_dir]
