...
- [Guidelines](guidelines/index.md) — atomic lessons + cluster aggregator pages (suffix `__cluster.md`); cluster pages are recall-preferred (0 atomic + 0 clusters)
- [Summaries](summaries/index.md) — episodic summaries (0 pages). Long sessions may be split into multiple arc-summaries that share a `session_id`.
